...
public class SearchItemService {
	 ...
	 *            ブランド検索
	 */
	public Integer checkArgument(String name, Integer smallCategory, Integer middleCategory, Integer largeCategory,
			String brand, Integer pageNumber, boolean isBrandSearch) {
	 ...
	 * @return アイテムリスト
	 */
	public List<Item> searchItem(String name, Integer smallCategory, Integer middleCategory, Integer largeCategory,
			String brand, Integer pageNumber, boolean isBrandSearch) {
	 ...
	 * @return
	 */
	public Integer forPageLimit(String name, Integer smallCategory, Integer middleCategory, Integer largeCategory,
			String brand, boolean isBrandSearch) {
		if (isBrandSearch == true) {
	 ...
	 * @return ページ上限
	 */
	public int setPageLimit(Integer itemAmount) {
